...
const AdminPage: React.FC = () => {
    ...
    function fetchAdmin() {
        ...
        let body = JSON.stringify(new AdminRequest(departureCity, store, sendCity, phoneNumber, entity, startDepartureDate,
            endDepartureDate, startOrderDate, endOrderDate, acceptanceDate, status, sortBy));
        ...
        <AdminLayout>
            <div className="page_content" style={{flexFlow: 'column'}}>
                ...
                <form className="admin_form" onSubmit={handleForm}>
                    ...
                    <button type="submit" className="change_password_button" style={{marginBottom: 50}}>Найти заказы
                    </button>
                </form>
                <div>
                ...
                <button className="login_button" onClick={setPopupTrue} style={{marginTop: 20}}>Изменить выбранные
                    заказы
                </button>
