    ...
    return (
        <div className="page_content" style={{ height: '90vh'}}>
            <div className="registration_window">
                <div className="popup_title">Регистрация</div>
                <div className="popup_desc" style={{color: '#5f5f5f', marginTop: 5}}>Личный кабинет</div>
                <form className="registration_form">
                    <input type="text" className="registration_input" placeholder="Имя"/>
                    ...
                    <button type="submit" className="registration_form_button">Зарегистрироваться</button>
                ...
                <Link to="/login" className="registration_to_login">
