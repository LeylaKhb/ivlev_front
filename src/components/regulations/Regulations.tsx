...
import regulations_5 from "../../static/regulations_5.png";
            ...
            <div className="regulations">
                ...
                <ol>
                    ...
                    <li>Оставить заявку на нашем сайте в разделе «Расписание поставок» <a
                        href="https://ivlev-ff.ru/schedule">
                        https://ivlev-ff.ru/schedule</a>. Оставлять заявку необходимо не позднее 22:00
                ...
                <ul>
                    ...
                    <li>Если на коробе не указано даты поставки на склад или указана дата несовпадающаяя с планом
                        поставок на сайте <a href="https://ivlev-ff.ru/">https://ivlev-ff.ru</a>, то поставка будет
                ...
                <p>Передать груз необходимо любому сотруднику нашего склада. В случае, если Вы пользуетесь услугой
                    ...
                    наш рабочий номер телефона: <b style={{textDecoration: 'underline'}}><a
                        href="tel:89171486688">89171486688</a></b>.</p>
                ...
                <p style={{textAlign: "center", textDecoration: 'underline'}}>Передача груза на фулфилмент в городе
                    Тольятти</p>
                <p>Наш склад находится по адресу: Московский проспект 6в</p>
                <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', margin: 15}}>
                    <img src={regulations_5} style={{width: '30%'}} alt="Рассчитать стоимость"/>
                </div>
                ...
                <span>В нём мы выложим всю информацию по данным водителей, в случае каких-либо изменений мы сразу же
                    ...
                    &nbsp;
                    <a href="tg://resolve?domain=Ivlevff">@Ivlevff</a> или позвонить по номеру телефона&nbsp;
                    <a href="tel:89171486688">89171486688</a>.</span>
