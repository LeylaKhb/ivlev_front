            ...
            <div className="regulations">
                ...
                <ul>
                    ...
                    <li>а также, для успешной сдачи груза на складах маркетплейсов. Просим внимательно ознакомиться
                        с нижеизложенной информацией, которая поможет избежать ошибок при сдаче груза
                    </li>
                </ul>

                <p style={{textAlign: "center"}}>Инструкция <span style={{textDecoration: 'underline'}}>перед записью на фулфилмент</span>
                </p>
                <ol>
                    <li>Подписаться на наш телеграмм-канал: <a
                        href="https://t.me/wbdostavkasamara">https://t.me/wbdostavkasamara</a>,
                        где мы выкладываем все важные объявления, касающиеся отгрузки на маркетплейсы. Все новости,
                        публикующиеся
                        в телеграмм-канале <a
                            href="https://t.me/wbdostavkasamara">https://t.me/wbdostavkasamara</a> являются частью
                        правил отгрузки.
                    </li>
                    <li>На нашем сайте <a href="http://localhost:3000/">http://localhost:3000</a> в разделе «Расписание
                    ...
                    <li>Создать у себя в личном кабинете маркетплейса поставку. В личном кабинете на маркетплейсе
                        ...
                        для поддержания связи с маркетплейсом.
                    </li>
                    <li>Оставить заявку на нашем сайте в разделе «Расписание поставок» <a
                        href="http://localhost:3000/raspisaniye">
                        http://localhost:3000/raspisaniye</a>. Оставлять заявку необходимо не позднее 22:00
                        <b>за день</b> до даты приёма груза на наш склад или забора груза с Вашего адреса.
                    </li>
                    <li>Созданную заявку необходимо оплатить до начала оказания услуг.</li>
                </ol>
                <p style={{textAlign: "center"}}>Инструкция <span style={{textDecoration: 'underline'}}>для подачи заявки на фулфилмент</span>
                </p>
                <ol>
                    <li>Выбираете желаемую дату отгрузки на склад маркетплейса (крупная дата слева, прим. 21.01.24)
                        ...
                        «приём до». Обратите внимание! В день приема груз принимается СТРОГО до 12:00!
                        <b>Бесплатное хранение: </b>Предоставляется для коробов, сдаваемых по заявке не ранее чем за 7
                        календарных дней до запланированной даты приемки.
                        <b>Платное хранение: </b>В случае сдачи коробов по заявке более чем за 7 календарных дней до
                        даты приемки, стоимость хранения составляет 100 рублей за паллетоместо ежедневно.
                    </li>
                    <li>В графе «Юридическое лицо» необходимо указать наименование ИП/ООО/Самозанятый. (прим. ИП Иванов,
                        ООО Иван и Ко, Самозанятый Иванов)
                    </li>
                    <li>В графе «Ваш номер телефона» необходимо указать номер человека, к которому можно обратиться
                        ...
                        актуальным и <b>в день сдачи груза</b> на маркетплейс.
                    </li>
                    ...
                    <li>В графе «Тип поставки» важно выбрать верный тип. <br/>
                        <ul>
                            <li>Короб – это поставка типа «короб», если у Вас один или несколько видов товара (один или
                                несколько штрих-кодов) в одном коробе.
                            </li>
                    ...
                    <li>В графе «Город отправки» необходимо указать город, с которого вы отправляете поставку
                        ...
                        выбранный город в заявке, изменить сумму в день отгрузки невозможно.
                    </li>
                    <li>В графе «Склад назначения» необходимо указать склад, в который Вы хотите отправить свой
                        товар (прим. Электросталь/Коледино/Тула)
                    </li>
                    ...
                    <li>В графе «Доп. комментарий»:
                        <ul>
                            ...
                            <li>если Вы записываетесь впервые, необходимо указать ссылку на Ваш телеграмм, на
                                ...
                                связь с нашим менеджером.
                            </li>
                        </ul>
                    </li>
                    <li>Нажать кнопку «Записаться». <b>ВАЖНО!</b> Если Вы оставляете сразу несколько заявок на разные
                        города и склады, необходимо после каждой заявки <b>обновлять страницу сайта</b> в браузере.
                    </li>
                    <li>Если Вы впервые пользуетесь услугами нашего фулфилмента, необходимо написать нашему
                        менеджеру в телеграмме <a href="tg://resolve?domain=Ivlevff">@Ivlevff</a>, наименование
                        юридического лица и сообщить, что Вы подали
                        заявку впервые. Это необходимо для того, чтобы мы внесли Вас в наш реестр и нам с Вами
                        было проще коммуницировать.
                    </li>
                </ol>

                <p style={{textAlign: "center", textDecoration: 'underline'}}>Правила подготовки груза для передачи на
                    фулфилмент</p>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        проследите, чтобы термоэтикетка не была заклеена сверху скотчем, так как это может привести к
                        потере информации на термоэтикетке. С той же стороны короба должен присутствовать упаковочный
                        лист, на котором должна быть следующая информация:
                        <ol>
                            <li>Номер короба;</li>
                            <li>Количество коробов в поставке;</li>
                            <li>Количество товара в коробе ;</li>
                    ...
                    <li>Если на коробе не указано даты поставки на склад или указана дата несовпадающаяя с планом
                        поставок на сайте <a href="http://localhost:3000/">http://localhost:3000</a>, то поставка будет
                        отправлена на ближайшую дату по расписанию фулфилмента
                    </li>
                    <li>
                ...
                <p>С Заводского шоссе поворачиваем на улицу Ближняя, проезжаем вглубь улицы, по левую сторону находятся
                    чёрные ворота с нашей вывеской «Фулфилмент», заезжаем в ворота и сразу поворачиваем направо.
                    Проезжаем до конца здания и поворачиваем налево, доезжаем до пандуса с фиолетово-розовой вывеской
                ...
                <p>Передать груз необходимо любому сотруднику нашего склада. В случае, если Вы пользуетесь услугой
                    курьеров, необходимо в комментарии курьеру подробно прописать схему проезда и предоставить курьеру
                    наш рабочий номер телефона: <b style={{textDecoration: 'underline'}}>89171486688</b>.</p>
                ...
                <p>Если Вы пользуетесь услугой «забор груза» нашим транспортным средством, то Ваш груз заберет наш
                    водитель в день приёмки товара в период с 9:00-14:00. Водитель обязательно позвонит Вам за 40 минут
                    до своего приезда, чтобы Вы смогли подготовить груз к отправке. Ожидание водителя на адресе
                    составляет 15 минут. В случае, если водитель не смог до Вас дозвониться за 40 минут до приезда на
                    адрес, чуть позже, он попробует позвонить Вам ещё раз. Если водитель со второго раза не дозвонился
                    до клиента, этот адрес удаляется из его маршрутного листа, при этом в счёт будет включена стоимость
                    забора.
                </p>
                <p>Если Вам нужна помощь при погрузке, Вы можете договориться об этом с водителем напрямую. Оплата за
                    погрузку осуществляется непосредственно водителю по Вашей с ним договорённости.
                </p>

                <p style={{textAlign: "center", textDecoration: 'underline'}}>Передача груза на фулфилмент в городе
                    Тольятти</p>
                <p>Наш склад находится по адресу: улица Коммунальная дом 24 строение 1.</p>
                <p>Заезд производится со стороны Олимпа, с торца здания, со стороны Революционной выезд! С торца есть
                    пандусы, левее них шлагбаум, под который надо заехать и проехать почти до конца здания ко второму
                    пандусу (Написано: Фулфилмент Ивлева). Если шлагбаум не открывают, необходимо посигналить.</p>
                <p>Передать груз необходимо любому сотруднику нашего склада. В случае, если Вы пользуетесь услугой
                    курьеров, необходимо в комментарии курьеру подробно прописать схему проезда и предоставить курьеру
                    наш рабочий номер телефона: <b style={{textDecoration: 'underline'}}>89171486688</b>.</p>
                <span>График работы склада:
                ...
                <p>Если Вы пользуетесь услугой «забор груза» нашим транспортным средством, то Ваш груз заберет наш
                    ...
                    минут до своего приезда, чтобы Вы смогли подготовить груз к отправке. Ожидание водителя на адресе
                    составляет 15 минут. В случае, если водитель не смог до Вас дозвониться за 40 минут до приезда на
                    адрес, чуть позже, он попробует позвонить Вам ещё раз. Если водитель со второго раза не дозвонился
                    до клиента, этот адрес удаляется из его маршрутного листа, при этом в счёт будет включена стоимость
                    забора.</p>

                <p>В городе Тольятти помощь в погрузке <span style={{textDecoration: 'underline'}}>водителем не осуществляется.</span>
                </p>

                <p style={{textAlign: "center", textDecoration: 'underline'}}>Доставка до склада маркетплейса</p>
                <p>После того, как Вы успешно передали груз на склад нашего фулфилмента, отслеживайте информацию в нашем
                    телеграмм-канале <a href="https://t.me/wbdostavkasamara">https://t.me/wbdostavkasamara</a> .
                </p>
                <span>В нём мы выложим всю информацию по данным водителей, в случае каких-либо изменений мы сразу же
                    оповестим Вас. Данные водителя обязательно будут выложены в период с даты приёма по дату сдачи на
                    склад маркетплейса. Если у Вас возникнут какие-либо вопросы, Вы можете написать нам в телеграмм:
                    &nbsp;
                    <a href="tg://resolve?domain=Ivlevff">@Ivlevff</a> или позвонить по номеру телефона 89171486688.</span>
                <p>В день приёма груза мы направляем напоминающую рассылку по тем заявкам, по которым не произведена
                    оплата. Оплату можно произвести двумя способами: Онлайн на сайте либо в офисе фулфилмента.</p>
                <span>В день сдачи груза на склад маркетплейса необходимо проверить Вашу поставку в личном кабинете на
                    наличие ошибок, обязательно быть на связи по номеру телефона, который Вы указывали в заявке. Это
                    нужно для того, чтобы мы могли с Вами оперативно связаться в случае возникновения каких-либо ошибок
                    или в случае отказа приёма груза маркетплейсом.</span>
                ...
                <span>Если при сдаче груза на склад маркетплейса возникает какая-либо ошибка, мы Вам об этом сообщим и
                    после её устранения будем повторно сдавать поставку. В случае, если ошибку невозможно устранить, мы
                    предложим Вам несколько вариантов, для решения данной ситуации (возврат в Самару, передача партнёрам
                    на ближайший фулфилмент и т.д.)</span>
                ...
                <p>Если Вы хотите перед отправкой груза воспользоваться нашей услугой упаковки товара, Вы можете
                    ...
                    <a href="tg://resolve?domain=Ivlevff_ff_package">@Ivlevff_ff_package</a>. Связь будет поддерживаться
                    по графику работы офиса (ПН-ПТ: 9:00-17:00). </p>
                ...
                <span>Если вы хотите уточнить или согласовать цену упаковки, Вы можете связаться с нами через телеграмм
                    <a href="tg://resolve?domain=Ivlevff">@Ivlevff</a>. Для согласования цены необходимо описать вид
                    товара, его количество, техническое задание, наличие или отсутствие собственных материалов для упаковки товара.
                </span>
                ...
                <p>Для физических лиц:
                    <ul>
                        ...
                        <li>
                            При оформлении забора нашими силами, а также доставке коробов на наш склад сторонними
                            организациями
                            <ol>
