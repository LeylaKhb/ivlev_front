        ...
        <div className="page_content">
            ...
            <div className="regulations">
                ...
                <p>Настоящая Политика конфиденциальности и обработки персональных данных (далее - Политика
                    ...
                    Интернет по адресу: <a href="http://localhost:3000">http://localhost:3000</a> (далее - Сайт).</p>
                ...
                <ol>
                    ...
                    <ol>
                        ...
                        <li>Настоящая Политика конфиденциальности применяется только к Сайту http://localhost:3000. Сайт
                            http://localhost:3000 не контролирует и не несет ответственности за сайты третьих лиц, на
                            которые Пользователь может перейти по ссылкам, доступным на Сайте http://localhost:3000.
                        </li>
                    </ol>
