        ...
        <div>
            <div className="price_header">
                <div className="price_header_svg_and_text">
                    ...
                    <label style={{fontSize: slide === 6 ? 20 : 12}}>
                        {slide === 6 ? "Оставьте свой номер телефона и мы свяжемся с вами в ближайшее время" : "Пройдите опрос и узнайте сколько будут стоить услугу фулфилмента для вашего бизнеса"}</label>
                </div>
